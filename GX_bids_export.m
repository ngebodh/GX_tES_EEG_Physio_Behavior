...
% raw data files (replace with your own)
 ...
 cd 'D:\GX\GX_tES_EEG_Physio_Behavior\BIDS_Convert\bids-matlab-tools-master'
% ----------------------------------
data(1).file = {'D:\GX\Data\0101\GX_01_2019-09-24_15-45-53.cnt'
                'D:\GX\Data\0101\GX_01_2019-09-27_17-11-55.cnt' 
                'D:\GX\Data\0101\GX_01_2019-10-11_19-04-28.cnt'};
data(1).session = [1 2 3];
data(1).run     = [1 1 1];

data(2).file = {'D:\GX\Data\0101\GX_02_2019-10-15_13-58-04.cnt'
                'D:\GX\Data\0101\GX_02_2019-10-15_15-34-45.cnt' 
                ' '};
data(2).session = [1 2 3];
data(2).run     = [1 1 3];
% 
...
% --------------------------------------------------
stimuli = {
%     '/data/matlab/tracy_mw/rate_mw.wav' 
...
chanlocs = 'D:\GX\GX_tES_EEG_Physio_Behavior\Standard-10-10-Cap33_V6_BIDS.loc';          


% call to the export function
% ---------------------------
bids_export(data, 'targetdir', 'C:\Users\TheBeast\Documents\Test', 'taskName', 'meditation', 'trialtype', trialTypes, 'gInfo', generalInfo, 'pInfo', pInfo, 'pInfoDesc', pInfoDesc, 'eInfoDesc', eInfoDesc, 'README', README, 'CHANGES', CHANGES, 'stimuli', stimuli, 'tInfo', tInfo, 'chanlocs', chanlocs);
...
bids_export(data, 'targetdir', 'C:\Users\TheBeast\Documents\Test2', 'taskName', 'meditation', 'gInfo', generalInfo, 'pInfo', pInfo, 'pInfoDesc', pInfoDesc, 'eInfoDesc', eInfoDesc, 'README', README, 'CHANGES', CHANGES, 'tInfo', tInfo, 'chanlocs', chanlocs);
